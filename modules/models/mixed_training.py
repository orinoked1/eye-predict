...
cnn_scanpath = cnn_multi_input.create_cnn(480, 600, 3, regress=False)
cnn_image = cnn_multi_input.create_cnn(480, 600, 3, regress=False)
...
fig.savefig("../../etp_data/processed/figs/train_val_acc.pdf", bbox_inches='tight')
plt.show()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
fig.savefig("../../etp_data/processed/figs/train_val_loss.pdf", bbox_inches='tight')
plt.show()
...
plt.title('ROC curve')
plt.legend(loc='best')
fig.savefig("../../etp_data/processed/figs/roc.pdf", bbox_inches='tight')
plt.show()
